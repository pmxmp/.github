...
## About PocketMineX-MP

PocketMineX-MP is a fork of [axolotl-pm/PocketMine-MP](https://github.com/axolotl-pm/PocketMine-MP), which is itself derived from the original [PocketMine-MP](https://github.com/pmmp/PocketMine-MP) project.
...
PocketMineX-MP inherits its license from its upstream sources (axolotl-pm/PocketMine-MP and PocketMine-MP). See the `LICENSE` file in the repository for details.
